...
.controller('ReportController', function($scope, $rootScope, $location, $window, Report) {

  $scope.report = {};
  $scope.diseases = [
    "African Trypanosomiasis", "Cholera", "Cryptosporidiosis", "Dengue Fever", "Hepatitis A", "Hepatitis B", "Hepatitis C",
    "HIV/AIDS", "Influenza", "Japanese Encephalitis", "Leishmaniasis", "Malaria", "Measles", "Meningitis", "Onchocerciasis",
    "Pneumonia", "Rotavirus", "Schistosomiasis", "Shigellosis", "Streptococcal pharyngitis", "Tuberculosis", "Typhoid", "Yellow Fever", "Ebola"
  ];
  $scope.diseases.sort();
